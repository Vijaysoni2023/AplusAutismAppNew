...
namespace aplusautism.Repository.Repository
{
    ...
    {
        private readonly AplusautismDbContext _context;
        ...
        public Repository(AplusautismDbContext context)
        {
            _context = context;
        ...
        /// </summary>
        /// <returns></returns>
        //public IEnumerable<T> GetUserDetail(LoginDTO login)
        //{
        ...
        //GetGlobalCodeCategory implement by me

        //public GlobalCodeCategory GetGlobalCodeCategories()
        //{
       ...
       // public List<T> GetUserForLogin(string Email, string Password)
       // {
        //   var u = Password;
        //    Expression<Func<T, bool>> filter = ( Username == Email && u.Password == Password && u.IsDeleted == false);
        //    Expression<Func<AB_User, bool>> whereClause = (u => u.UserName == Email && u.Password == Password && u.IsDeleted == false);
        //    var userDetails = _entities.Where(filter);
